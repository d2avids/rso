...
#     PrizePlacesInDistrAndInterregLaborProjects, Score
# )


# @pytest.mark.django_db(transaction=True, reset_sequences=True)
# class TestPrizePlacesInDistrAndInterregLaborProjectsViewSet:
#     competition_url = '/api/v1/competitions/'
#     question_url = '/reports/prize_places_in_distr_and_interreg_labor_projects/'
...
#         )
#         new_report = PrizePlacesInDistrAndInterregLaborProjects.objects.filter(
...
#             verif_report = PrizePlacesInDistrAndInterregLaborProjects.objects.get(
...
#             assert (
#                 scores[0].prize_places_in_distr_and_interreg_labor_projects ==
...
#         scores = Score.objects.filter(
#             competition=competition,
#             detachment=report_question11_verif.detachment
#         ).all()
...
#         self, authenticated_client_3, participants_competition_tandem,
#         competition, report_question11_not_verif,
#         report_question11_verif_second,
...
#                 "competition": report_question11_verif.competition.id,
#             },
#             format='json'
#         )
#         assert response.status_code == HTTPStatus.BAD_REQUEST, (
