...
from competitions.models import Q10, Q10Report


@pytest.mark.django_db(transaction=True, reset_sequences=True)
class TestQ10ViewSet:
    competition_url = '/api/v1/competitions/'
    question_url = '/reports/q10/'
    ...
    def test_create_report_participant(
        ...
        global_report = Q10Report.objects.filter(
    ...
    def test_put_number_participants_reg_commander(
        ...
        scores = Q10Report.objects.filter(
            competition=competition,
            detachment=report_question10_verif.detachment_report.detachment
        ).all()
    ...
    def test_me_with_report(
        self, authenticated_client_3, participants_competition_tandem,
        competition, report_question10_not_verif, report_question10_verif_second,
